...
extern "C"
void fp_prod(uint32_t* output, const uint32_t* left, const uint32_t* right) {
    uint32_t carry0;
    uint32_t carry1;
    uint32_t o0;
    uint32_t o1;
    ...
    register uint64_t val = ((const uint64_t *)left)[0];
